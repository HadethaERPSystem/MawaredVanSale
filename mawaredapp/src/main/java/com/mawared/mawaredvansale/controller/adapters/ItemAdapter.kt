        ...
        with(holder.itemView){
            try {
                ...
                if (item.pr_price_AfD != null && item.pr_price_AfD != 0.0) {
                    ...
                    old_price.text =
                        "${item.pr_unit_price.toString()}  ${App.prefs.saveUser!!.sl_cr_code!!}"
                } else {
                    new_price.text =
                        "${item.pr_unit_price.toString()}  ${App.prefs.saveUser!!.sl_cr_code!!}"
                }
                ...
                if (extraParameter == "Y") {
                    ...
                    discBtn.visibility =
                        if (item.pr_dis_per != null && item.pr_dis_per!! > 0.0 && App.prefs.user_item_disc == "0.0") View.GONE else View.VISIBLE
                    giftBtn.visibility =
                        if (App.prefs.saveUser!!.hasGift == "N") View.GONE else View.VISIBLE
