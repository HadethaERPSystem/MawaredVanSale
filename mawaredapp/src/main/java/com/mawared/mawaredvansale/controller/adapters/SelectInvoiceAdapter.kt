...
import kotlinx.android.synthetic.main.item_rv_invoice.view.*


class SelectInvoiceAdapter(@LayoutRes private val layoutResource: Int, private val clickFunc1: (InventoryDoc) -> Unit) : BaseAdapter<InventoryDoc>(null, layoutResource) {
