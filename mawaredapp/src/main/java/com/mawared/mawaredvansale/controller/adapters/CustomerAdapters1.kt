...
class CustomerAdapter1(context: Context, @LayoutRes private val layoutResource: Int):
    ArrayAdapter<Customer>(context, layoutResource), Filterable {

    private var mCustomers: List<Customer> = arrayListOf()
    private var allCustomers: List<Customer> = arrayListOf()
