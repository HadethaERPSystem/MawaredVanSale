...
//            R.drawable.ic_logo_black, "Mawared Vansale\nAL-HADETHA FRO SOFTWATE & AUTOMATION", null, null)
        ...
        val fontNameAr = "assets/fonts/arial.ttf"// "assets/fonts/droid_kufi_regular.ttf"
            try {
                ...
                header.add(HeaderFooterRow(0, null, "Al-Nadir Trading Company",  14F, Element.ALIGN_CENTER, Font.NORMAL, fontNameEn))
                header.add(HeaderFooterRow(1, null, "${entityEo.sl_org_name}", 14F, Element.ALIGN_CENTER, Font.NORMAL, fontNameEn))
                header.add(HeaderFooterRow(2, null, phones, 11F, Element.ALIGN_CENTER, Font.NORMAL, fontNameEn))
                //header.add(HeaderFooterRow(3, null, "Asia: 0770-6502228", 20F, Element.ALIGN_CENTER, Font.BOLD, fontNameEn))
                header.add(HeaderFooterRow(3, null, "شركة النادر التجارية", 14F, Element.ALIGN_CENTER, Font.NORMAL, fontNameAr ))
                ...
                tbl.put(1,TCell(ctx!!.resources!!.getString(R.string.rpt_list_name), 9f, false, 15F, "", Element.ALIGN_RIGHT, 0))
                tbl.put(2,TCell(entityEo.sl_vo_name!!,9F, false, 30F, "", com.itextpdf.text.Element.ALIGN_RIGHT, 0))

                tbl.put(3,TCell(ctx!!.resources!!.getString(R.string.rpt_invoice_no), 9F, false, 15F, "", Element.ALIGN_RIGHT, 0))
                tbl.put(4,TCell(entityEo.sl_refNo!!,9F, false, 30F, "", com.itextpdf.text.Element.ALIGN_RIGHT, 0))

                tbl.put(5,TCell(ctx!!.resources!!.getString(R.string.rpt_invoice_date) ,9F, false, 10F, "", com.itextpdf.text.Element.ALIGN_RIGHT,0,fontName = fontNameAr))
                tbl.put(6,TCell( returnDateString(entityEo.sl_doc_date!!),9F, false, 25F, "", com.itextpdf.text.Element.ALIGN_RIGHT,0,fontName = fontNameAr))
                ...
                tbl.put(1,TCell(ctx!!.resources!!.getString(R.string.rpt_customer) ,9F, false, 12F,"", Element.ALIGN_RIGHT,0,fontName = fontNameAr) )
                ...
                tbl.put(5,TCell(ctx!!.resources!!.getString(R.string.rpt_customer_phone), 9F, false, 12F, "", com.itextpdf.text.Element.ALIGN_RIGHT, 0))
                ...
                tbl.put(7,TCell(ctx!!.resources!!.getString(R.string.rpt_cr_name) , 9F, false, 18F, "", com.itextpdf.text.Element.ALIGN_RIGHT, 0))
                ...
                rowHeader.put(2, RowHeader(ctx!!.resources!!.getString(R.string.rpt_prod_name), 9.0F, false, 30, "", 0, 0F))
                ...
                GeneratePdf().createPdf(activity!!,imgLogo, entityEo.items, rowHeader, header, footer,null, summary, isRTL) { _, path ->
