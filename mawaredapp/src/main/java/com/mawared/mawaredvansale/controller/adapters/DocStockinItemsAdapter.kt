...
class DocStockinItemsAdapter(@LayoutRes private val layoutResource: Int, private val clickFunc1: (InventoryDocLines, Loc, Double, Success:()-> Unit) -> Unit, private val clickFunc2:(InventoryDocLines, Loc, Double, ItemLocsAdapter)-> Unit) : BaseAdapter<InventoryDocLines>(null, layoutResource) {
