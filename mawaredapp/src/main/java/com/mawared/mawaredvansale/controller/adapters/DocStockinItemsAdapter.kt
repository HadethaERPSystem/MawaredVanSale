...
import kotlinx.android.synthetic.main.item_rv_stockin_doc_item.view.*


class DocStockinItemsAdapter(@LayoutRes private val layoutResource: Int, private val clickFunc1: (InventoryDocLines, Loc, Double, Success:()-> Unit) -> Unit, private val clickFunc2:(InventoryDocLines, Loc, Double, StockInItemLocsAdapter)-> Unit) : BaseAdapter<InventoryDocLines>(null, layoutResource) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        with(holder.itemView){
            val view = this
            val itemSelectedlocAdapter = StockInItemLocsAdapter(R.layout.item_lv_locations, item){l ->
            ...
            val itemlocAdapter = StockInItemLocsAdapter(R.layout.item_lv_locations, item){
