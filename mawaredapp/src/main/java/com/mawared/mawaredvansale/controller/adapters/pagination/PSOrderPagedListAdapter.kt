...
import com.mawared.mawaredvansale.controller.sales.psorder.psorderlist.PSOrdersViewModel
...
class PSOrderPagedListAdapter(private val viewModel: PSOrdersViewModel, val context: Context):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if(viewType == ORDER_VIEW_TYPE){
            val bind : PsorderRowBinding= DataBindingUtil.inflate(inflater, R.layout.psorder_row, parent, false)
    ...
    class OrderItemViewHolder(view: View, private val viewBinding: PsorderRowBinding): RecyclerView.ViewHolder(view){
        fun bind(order: Sale_Order?, viewModel: PSOrdersViewModel){
