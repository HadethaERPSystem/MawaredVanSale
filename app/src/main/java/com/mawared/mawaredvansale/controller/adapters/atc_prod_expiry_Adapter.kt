...
class atc_prod_expiry_Adapter(context: Context, @LayoutRes private val layoutResource: Int, private val productList: List<Product>):
   ArrayAdapter<Product>(context, layoutResource, productList) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val binding: ProductAutocompleteRowBinding = DataBindingUtil.inflate(layoutInflater, R.layout.product_expiry_atc_row, parent, false)
